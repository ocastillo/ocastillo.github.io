            ...
            <DefaultLayout {...this.props}>
                ...
                <div id="page-wrapper">
                    ...
                    <header id="header" className="alt">
                        <h1><a href="index.html">Orlando Castillo</a></h1>
                        <nav id="nav">
                            <ul>
                    ...
                    <section id="two" className="wrapper alt style2">
                        <section className="spotlight">
                            <div className="image"><img src="/static/images/pic01.jpg" alt="" /></div><div className="content">
                        ...
                        <section className="spotlight">
                            <div className="image"><img src="/static/images/pic02.jpg" alt="" /></div><div className="content">
                        ...
                        <section className="spotlight">
                            <div className="image"><img src="/static/images/pic03.jpg" alt="" /></div><div className="content">
